...
class Event(models.Model):
	...
	price = models.DecimalField(blank=False, max_digits=7, decimal_places=2, verbose_name='Price:')
	promoCode = models.CharField(max_length=10, verbose_name='Promo code:')
