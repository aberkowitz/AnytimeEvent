...
class Event(models.Model):
	...
	price = models.DecimalField(blank=False, max_digits=3, decimal_places=2, verbose='Promo code for attendees:')
	...
	eventDate = models.DateTimeField(False, False, verbose_name='Date:')
